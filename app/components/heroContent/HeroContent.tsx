...
export const HeroContent: React.FC<props> = ({ data }) => {
  return (
    <div className="block text-white space-y-2 w-2/3 mx-auto">
      ...
      <button className=" p-2 rounded-sm bg-black text-white mt-2 hover:text-black hover:bg-white transition-all duration-700 hover:shadow-2xl hove:mt-0  drop-shadow shadow-black">
